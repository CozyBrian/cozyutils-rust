const COMMANDS: &[(&str, &str, &str)] = &[
    (
        "-cmsg",
        "[--out=path] [--model=gemini-3-flash-preview] [--backend=gemini|apple] [--clipboard] [--clipboard-only] [--commit]",
        "Generate a commit message from staged changes via Gemini or Apple Intelligence",
    ),
    (
        "-svg2tsx",
    ...
    (
        "-prmsg",
        "[--base=origin/dev] [--out=path] [--model=gemini-3-flash-preview] [--backend=gemini|apple] [--clipboard] [--clipboard-only] [--setup]",
        "Generate a PR message from git diffs via Gemini or Apple Intelligence",
    ),
];
